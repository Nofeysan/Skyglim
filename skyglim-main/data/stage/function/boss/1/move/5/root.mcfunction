...
execute if score s1 BossMoves matches 220 run effect give @n[predicate=entity:entity_enemy, tag=boss, tag=s1] minecraft:levitation 1 3

execute if score s1 BossMoves matches 240 run effect give @a[distance=..30, predicate=damageapi:is_on_ground] minecraft:wind_charged 1 50
execute if score s1 BossMoves matches 240 run particle minecraft:block{block_state: "minecraft:dirt"} ~ ~ ~ 10 0.2 10 0.1 480
execute if score s1 BossMoves matches 240.. run scoreboard players set s1 BossMoves 0
