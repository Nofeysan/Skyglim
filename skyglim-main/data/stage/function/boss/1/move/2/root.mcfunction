...
# aec
execute at @n[predicate=entity:entity_enemy, tag=boss, tag=s1] at @a[distance=..30] positioned ~ 12 ~ run function entity:aec_manager/summon/.square {r: 20, t: 80, dmg: 15, str: 10, id: 11}
