...
summon minecraft:skeleton ~ ~ ~ \
                        {\
                            ...
                            equipment: {\
                                ...
                                offhand: {id: "minecraft:tipped_arrow", components: {"minecraft:potion_contents": {custom_color: 14143973, custom_effects: [{id: "minecraft:hunger", duration: 60, amplifier: 55}, {id: "minecraft:wind_charged", duration: 2, amplifier: 8}, {id: "minecraft:slowness", duration: 60, amplifier: 1}]}, "minecraft:enchantment_glint_override": true}}\
                            },\
                            drop_chances: {\
