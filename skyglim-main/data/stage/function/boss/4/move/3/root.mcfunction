...
# AoE
execute if score s4 BossMoves matches 200 at @a[distance=..30] run function entity:aec_manager/summon/.square {r: 8, t: 30, dmg: 75, str: 55, id: 41}
execute if score s4 BossMoves matches 210 at @a[distance=..30] run function entity:aec_manager/summon/.square {r: 8, t: 30, dmg: 75, str: 55, id: 41}
execute if score s4 BossMoves matches 220 at @a[distance=..30] run function entity:aec_manager/summon/.square {r: 8, t: 30, dmg: 75, str: 55, id: 41}
execute if score s4 BossMoves matches 230 at @a[distance=..30] run function entity:aec_manager/summon/.square {r: 8, t: 30, dmg: 75, str: 55, id: 41}
execute if score s4 BossMoves matches 240 at @a[distance=..30] run function entity:aec_manager/summon/.square {r: 8, t: 30, dmg: 75, str: 55, id: 41}
