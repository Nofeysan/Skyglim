...
# boss
tp @n[predicate=entity:entity_enemy, tag=boss, tag=s4] ~ ~ ~
effect give @n[predicate=entity:entity_enemy, tag=boss, tag=s4] minecraft:slowness 10 99
particle minecraft:end_rod ~ ~ ~ 0.5 0.8 0.5 0.1 120
