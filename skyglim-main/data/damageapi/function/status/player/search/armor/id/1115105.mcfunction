...
# check
    execute if score $armor_id_chest _ matches 1115106 if score $armor_id_legs _ matches 1115107 if score $armor_id_feet _ matches 1115108 run \
        data modify storage status: book.defp set value '§b(+10%)'
