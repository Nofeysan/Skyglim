...
# check
    execute if score $armor_id_chest _ matches 1202106 if score $armor_id_legs _ matches 1202107 if score $armor_id_feet _ matches 1202108 run \
        data modify storage status: book.cdp set value '§b(+15%)'
