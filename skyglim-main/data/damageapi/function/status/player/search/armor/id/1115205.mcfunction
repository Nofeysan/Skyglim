...
# check
    execute if score $armor_id_chest _ matches 1115206 if score $armor_id_legs _ matches 1115207 if score $armor_id_feet _ matches 1115208 run \
        data modify storage status: book.dmgp set value '§b(+3)'
