...
# check
    execute if score $armor_id_chest _ matches 1114106 if score $armor_id_legs _ matches 1114107 if score $armor_id_feet _ matches 1114108 run \
        data modify storage status: book.strp set value '§b(+5%)'
