...
# check
    execute if score $armor_id_chest _ matches 1203006 if score $armor_id_legs _ matches 1203007 if score $armor_id_feet _ matches 1203008 run \
        data modify storage status: book.hpp set value '§b(+10%)'

    execute if score $armor_id_chest _ matches 1203006 if score $armor_id_legs _ matches 1203007 if score $armor_id_feet _ matches 1203008 run \
        data modify storage status: book.defp set value '§b(+15%)'
