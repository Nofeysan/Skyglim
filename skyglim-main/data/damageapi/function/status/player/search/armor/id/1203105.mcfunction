...
# check
    execute if score $armor_id_chest _ matches 1203106 if score $armor_id_legs _ matches 1203107 if score $armor_id_feet _ matches 1203108 run \
        scoreboard players add magic Temp 40
