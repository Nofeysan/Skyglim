...
# check
    execute if score $armor_id_chest _ matches 1115006 if score $armor_id_legs _ matches 1115007 if score $armor_id_feet _ matches 1115008 run \
        data modify storage status: book.strp set value '§b(+10%)'
