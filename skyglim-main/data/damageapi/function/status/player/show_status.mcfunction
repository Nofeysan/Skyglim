...
execute if score @s Absorption matches 1.. run data modify storage status: show.hp set value [{text: "\uE000\uf101"},{text: "HP ", color:"#e6a4a7"},{"score": {"name": "@s", "objective": "ShowCurrentHealth"}, color: "#e6a4a7", font: "hp"},{text: "+", color: "#f5de84", font: "crit_damage"},{"score": {"name":"@s", "objective": "ShowAbsorption"}, color: "#f5de84", font: "crit_damage"},{text: "/", color: "#e6a4a7", font: "hp"},{"score": {"name": "@s", "objective": "ShowMaxHealth"}, color:"#e6a4a7", font: "hp"}]
