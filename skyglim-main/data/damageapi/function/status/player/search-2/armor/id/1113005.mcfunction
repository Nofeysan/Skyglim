...
# check
    execute if score $armor_id_chest _ matches 1113006 if score $armor_id_legs _ matches 1113007 if score $armor_id_feet _ matches 1113008 run \
        scoreboard players add magic Temp 10
