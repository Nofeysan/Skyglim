...
# check
    execute if score $armor_id_chest _ matches 1202006 if score $armor_id_legs _ matches 1202007 if score $armor_id_feet _ matches 1202008 run \
    scoreboard players add luck multi 20
