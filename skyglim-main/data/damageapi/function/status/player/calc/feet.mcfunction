##? data get entity @s Inventory[{Slot:100b}].components.minecraft:custom_data.status.<id> で取得
data modify storage calc_stats: temp set from entity @s Inventory[{Slot:100b}].components.minecraft:custom_data
