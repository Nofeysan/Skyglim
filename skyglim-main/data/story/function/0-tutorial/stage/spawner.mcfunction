...
[\
    ...
    {translate: "stage.tutorial.spaener.name", color: "#ffd728"}, \
    {translate: "tutorial.stats.right", color: "#94d3e6"}\
]

tellraw @s [{translate: "stage.tutorial.spaener.description.1"}]
tellraw @s [{translate: "stage.tutorial.spaener.description.2"}]
