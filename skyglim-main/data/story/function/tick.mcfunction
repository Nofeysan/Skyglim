...
# 村人との会話
execute if entity @a[scores={TalkToVillager=1..}] as @a[scores={TalkToVillager=1..}] run function story:villager/talk/root with entity @n[type=minecraft:villager] data.role
