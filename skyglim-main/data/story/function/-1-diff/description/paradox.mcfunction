...
[\
    ...
    {text: "Paradox", color: "dark_purple"}, \
    {translate: "tutorial.stats.right", color: "#94d3e6"}\
]

tellraw @s [{translate: "difficulty.paradox.description"}, "\n"]

tellraw @s {translate: "difficulty.select.button", click_event: {action: "run_command", command: "trigger story.trigger set 4"}}
