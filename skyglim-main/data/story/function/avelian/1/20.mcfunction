...
# tellraw
tellraw @a [{translate: "story.avelian"}, {translate: "story.avelian.1-20"}]

# 自動進行
schedule function story:avelian/1/sit 100t
...
execute at @n[tag=aj.skyglim.avelian.root] run playsound minecraft:entity.wither.spawn voice @a ~ ~ ~ 0.7 1.5
