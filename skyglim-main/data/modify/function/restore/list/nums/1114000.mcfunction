#> modify:restore/list/nums/1114000
# 
# 1. 基礎値を設定する
...
scoreboard players set base Temp 66
...
data modify storage modify: restore.name set value 'stage.14.e-sword.1.name'

##* 武器種ごとの共通設定
function modify:restore/list/nums/type/sword {id: "iron_sword"}
