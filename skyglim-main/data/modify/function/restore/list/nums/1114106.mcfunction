#> modify:restore/list/nums/1114106
# 
# 1. 基礎値を設定する
...
data modify storage modify: restore.name set value 'stage.14.e-chest.2.name'
...
# dyed color
data modify block ~ ~-1 ~ Items[{Slot: 13b}].components merge value {"minecraft:dyed_color": 13901085}
