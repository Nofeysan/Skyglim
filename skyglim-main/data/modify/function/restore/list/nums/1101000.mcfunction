...
data modify storage modify: restore.name set value 'stage.1.old-sword.name'

# id と見た目の設定
data modify block ~ ~-1 ~ Items[{Slot:13b}].id set value "minecraft:feather"
data modify block ~ ~-1 ~ Items[{Slot:13b}].components."minecraft:item_model" set value "minecraft:wooden_sword"
