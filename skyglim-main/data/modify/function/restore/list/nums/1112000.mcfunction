#> modify:restore/list/nums/1112000
# 
# 1. 基礎値を設定する
...
data modify storage modify: restore.name set value 'stage.12.l-sword.1.name'

##* 武器種ごとの共通設定
function modify:restore/list/nums/type/sword {id: "diamond_hoe"}
