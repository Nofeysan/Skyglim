#> modify:restore/list/nums/1115210
# 
# 1. 基礎値を設定する
...
scoreboard players set base Temp -31
...
scoreboard players set base Temp 175
...
data modify storage modify: restore.name set value 'stage.15.l-shard.31.name'

##* 武器種ごとの共通設定
function modify:restore/list/nums/type/shard {id: "slime_block"}
