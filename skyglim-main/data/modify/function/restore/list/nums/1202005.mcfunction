#> modify:restore/list/nums/1202005
# 
# 1. 基礎値を設定する
...
data modify storage modify: restore.name set value 'stage.ex2.e-head.1.name'

##* 武器種ごとの共通設定
function modify:restore/list/nums/type/armor {id: "diamond_helmet"}
