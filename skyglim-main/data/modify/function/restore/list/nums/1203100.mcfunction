#> modify:restore/list/nums/1203100
# 
# 1. 基礎値を設定する
...
scoreboard players set base Temp 84
...
scoreboard players set base Temp 103
...
data modify storage modify: restore.name set value 'stage.ex3.m-sword.2.name'

##* 武器種ごとの共通設定
function modify:restore/list/nums/type/sword {id: "netherite_sword"}
