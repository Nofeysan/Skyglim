#> modify:restore/list/nums/1203002
# 
# 1. 基礎値を設定する
...
scoreboard players set base Temp 126
...
data modify storage modify: restore.name set value 'stage.ex3.m-axe.1.name'

##* 武器種ごとの共通設定
function modify:restore/list/nums/type/axe {id: "netherite_axe"}
