#> modify:restore/list/nums/1109008
# 
# 1. 基礎値を設定する
...
data modify storage modify: restore.name set value 'stage.9.n-boots.1.name'

##* 武器種ごとの共通設定
function modify:restore/list/nums/type/armor {id: "chainmail_boots"}
