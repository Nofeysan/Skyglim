#> modify:restore/list/nums/1203106
# 
# 1. 基礎値を設定する
...
data modify storage modify: restore.name set value 'stage.ex3.m-chest.2.name'

##* 武器種ごとの共通設定
function modify:restore/list/nums/type/armor {id: "leather_chestplate"}

# trim
data modify block ~ ~-1 ~ Items[{Slot: 13b}].components."minecraft:trim" merge value {material: "diamond", pattern: "flow"}

# dyed color
data modify block ~ ~-1 ~ Items[{Slot: 13b}].components merge value {"minecraft:dyed_color": 4527496}
