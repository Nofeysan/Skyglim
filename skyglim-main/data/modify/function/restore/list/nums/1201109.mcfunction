#> modify:restore/list/nums/1201109
# 
# 1. 基礎値を設定する
...
data modify storage modify: restore.name set value 'stage.ex1.r-shard.20.name'

##* 武器種ごとの共通設定
function modify:restore/list/nums/type/shard {id: "stick"}
