#> modify:restore/list/nums/1107002
# 
# 1. 基礎値を設定する
...
data modify storage modify: restore.name set value 'stage.7.e-axe.1.name'

##* 武器種ごとの共通設定
function modify:restore/list/nums/type/axe {id: "copper_axe"}
