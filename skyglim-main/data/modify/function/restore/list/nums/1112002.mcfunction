#> modify:restore/list/nums/1112002
# 
# 1. 基礎値を設定する
...
data modify storage modify: restore.name set value 'stage.12.l-axe.1.name'

##* 武器種ごとの共通設定
function modify:restore/list/nums/type/axe {id: "netherite_shovel"}
