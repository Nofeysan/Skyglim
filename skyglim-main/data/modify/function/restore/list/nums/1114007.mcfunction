#> modify:restore/list/nums/1114007
# 
# 1. 基礎値を設定する
...
scoreboard players set base Temp 59
...
scoreboard players set base Temp 42
...
data modify storage modify: restore.name set value 'stage.14.e-legs.1.name'
...
# dyed color
data modify block ~ ~-1 ~ Items[{Slot: 13b}].components merge value {"minecraft:dyed_color": 5361784}
