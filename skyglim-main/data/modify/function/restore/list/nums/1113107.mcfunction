#> modify:restore/list/nums/1113107
# 
# 1. 基礎値を設定する
...
data modify storage modify: restore.name set value 'stage.13.r-legs.2.name'

##* 武器種ごとの共通設定
function modify:restore/list/nums/type/armor {id: "leather_leggings"}

# dyed color
data modify block ~ ~-1 ~ Items[{Slot: 13b}].components merge value {"minecraft:dyed_color": 6448483}
