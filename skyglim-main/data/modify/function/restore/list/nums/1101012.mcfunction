#> modify:restore/list/nums/1101012
# 
# 1. 基礎値を設定する
...
data modify storage modify: restore.name set value 'stage.1.n-legs.name'

# id と見た目の設定
data modify block ~ ~-1 ~ Items[{Slot:13b}].id set value "minecraft:leather_leggings"
