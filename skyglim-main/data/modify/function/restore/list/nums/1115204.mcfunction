#> modify:restore/list/nums/1115204
# 
# 1. 基礎値を設定する
...
scoreboard players set base Temp 56
...
data modify storage modify: restore.name set value 'stage.15.l-crossbow.3.name'

##* 武器種ごとの共通設定
function modify:restore/list/nums/type/crossbow {p: 3, q: 12, m: 1}
