#> modify:restore/list/nums/1202110
# 
# 1. 基礎値を設定する
...
data modify storage modify: restore.name set value 'stage.ex2.e-shard.21.name'

##* 武器種ごとの共通設定
function modify:restore/list/nums/type/shard {id: "powered_rail"}
