#> modify:restore/list/nums/1111110
# 
# 1. 基礎値を設定する
...
data modify storage modify: restore.name set value 'stage.11.e-shard.21.name'

##* 武器種ごとの共通設定
function modify:restore/list/nums/type/shard {id: "ocelot_spawn_egg"}
