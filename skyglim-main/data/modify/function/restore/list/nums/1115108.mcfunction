#> modify:restore/list/nums/1115108
# 
# 1. 基礎値を設定する
...
scoreboard players set base Temp 47
...
data modify storage modify: restore.name set value 'stage.15.l-boots.2.name'
...
# dyed color
data modify block ~ ~-1 ~ Items[{Slot: 13b}].components merge value {"minecraft:dyed_color": 10921638}
