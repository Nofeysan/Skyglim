#> modify:restore/list/nums/1203010
# 
# 1. 基礎値を設定する
...
data modify storage modify: restore.name set value 'stage.ex3.m-shard.11.name'

##* 武器種ごとの共通設定
function modify:restore/list/nums/type/shard {id: "arms_up_pottery_sherd"}
