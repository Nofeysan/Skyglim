#> modify:restore/list/nums/1115001
# 
# 1. 基礎値を設定する
...
data modify storage modify: restore.name set value 'stage.15.l-s.sword.1.name'

##* 武器種ごとの共通設定
function modify:restore/list/nums/type/s.sword {id: "feather"}

# custom_model_data
data modify block ~ ~-1 ~ Items[{Slot: 13b}].components."minecraft:custom_model_data".strings set value ["s.s.netherite"]
