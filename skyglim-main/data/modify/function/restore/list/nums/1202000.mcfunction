#> modify:restore/list/nums/1202000
# 
# 1. 基礎値を設定する
...
scoreboard players set base Temp 86
...
data modify storage modify: restore.name set value 'stage.ex2.e-sword.1.name'

##* 武器種ごとの共通設定
function modify:restore/list/nums/type/sword {id: "golden_sword"}
