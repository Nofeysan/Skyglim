#> modify:restore/list/nums/1106102
# 
# 1. 基礎値を設定する
...
data modify storage modify: restore.name set value 'stage.6.r-axe.2.name'

##* 武器種ごとの共通設定
function modify:restore/list/nums/type/axe {id: "stone_axe"}
