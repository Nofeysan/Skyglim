#> modify:restore/list/nums/1111107
# 
# 1. 基礎値を設定する
...
data modify storage modify: restore.name set value 'stage.11.e-legs.2.name'

##* 武器種ごとの共通設定
function modify:restore/list/nums/type/armor {id: "iron_leggings"}

# trim
data modify block ~ ~-1 ~ Items[{Slot: 13b}].components."minecraft:trim" merge value {material: "resin", pattern: "dune"}
