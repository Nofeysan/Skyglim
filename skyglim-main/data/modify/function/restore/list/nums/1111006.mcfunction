#> modify:restore/list/nums/1111006
# 
# 1. 基礎値を設定する
...
data modify storage modify: restore.name set value 'stage.11.e-chest.1.name'

##* 武器種ごとの共通設定
function modify:restore/list/nums/type/armor {id: "iron_chestplate"}

# trim
data modify block ~ ~-1 ~ Items[{Slot: 13b}].components."minecraft:trim" merge value {material: "netherite", pattern: "sentry"}

# dyed color
data modify block ~ ~-1 ~ Items[{Slot: 13b}].components merge value {"minecraft:dyed_color": 2038816}
