#> modify:restore/list/nums/1203209
# 
# 1. 基礎値を設定する
...
# ランダム指定
execute store result score _ _ run random value 1..5

execute if score _ _ matches 1 run function modify:restore/list/nums/1203210-1
execute if score _ _ matches 2 run function modify:restore/list/nums/1203210-2
execute if score _ _ matches 3 run function modify:restore/list/nums/1203210-3
execute if score _ _ matches 4 run function modify:restore/list/nums/1203210-4
execute if score _ _ matches 5 run function modify:restore/list/nums/1203210-5
...
data modify storage modify: restore.name set value 'stage.ex3.m-shard.31.name'

##* 武器種ごとの共通設定
function modify:restore/list/nums/type/shard {id: "clock"}

# custom_model_data
data modify block ~ ~-1 ~ Items[{Slot: 13b}].components."minecraft:custom_model_data".strings set value ["1203210"]
