...
data modify storage modify: restore.name set value 'stage.4.r-shard.1.name'

# id と見た目の設定
data modify block ~ ~-1 ~ Items[{Slot:13b}].id set value "minecraft:clock"
data modify block ~ ~-1 ~ Items[{Slot:13b}].components."minecraft:item_model" set value "minecraft:apple"
