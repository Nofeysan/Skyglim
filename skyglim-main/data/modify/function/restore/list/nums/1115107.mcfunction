#> modify:restore/list/nums/1115107
# 
# 1. 基礎値を設定する
...
scoreboard players set base Temp 72
...
scoreboard players set base Temp 54
...
data modify storage modify: restore.name set value 'stage.15.l-legs.2.name'
...
# dyed color
data modify block ~ ~-1 ~ Items[{Slot: 13b}].components merge value {"minecraft:dyed_color": 12763330}
