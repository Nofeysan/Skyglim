...
data modify storage modify: restore.name set value 'stage.3.n-head.name'

# id と見た目の設定
data modify block ~ ~-1 ~ Items[{Slot:13b}].id set value "minecraft:leather_helmet"
...
data modify block ~ ~-1 ~ Items[{Slot: 13b}].components."minecraft:dyed_color" merge value 1399829
