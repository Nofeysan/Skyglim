#> modify:restore/list/nums/1203200
# 
# 1. 基礎値を設定する
...
scoreboard players set base Temp 140
...
data modify storage modify: restore.name set value 'stage.ex3.m-sword.3.name'

##* 武器種ごとの共通設定
function modify:restore/list/nums/type/sword {id: "diamond_sword"}
