#> modify:restore/list/nums/1115008
# 
# 1. 基礎値を設定する
...
data modify storage modify: restore.name set value 'stage.15.l-boots.1.name'

##* 武器種ごとの共通設定
function modify:restore/list/nums/type/armor {id: "golden_boots"}
