#> modify:restore/list/nums/1109006
# 
# 1. 基礎値を設定する
...
data modify storage modify: restore.name set value 'stage.9.n-chest.1.name'

##* 武器種ごとの共通設定
function modify:restore/list/nums/type/armor {id: "chainmail_chestplate"}

# trim
data modify block ~ ~-1 ~ Items[{Slot: 13b}].components."minecraft:trim" merge value {material: "redstone", pattern: "rib"}
