#> modify:restore/list/nums/1203104
# 
# 1. 基礎値を設定する
...
scoreboard players set base Temp 123
...
data modify storage modify: restore.name set value 'stage.ex3.m-crossbow.2.name'

##* 武器種ごとの共通設定
function modify:restore/list/nums/type/crossbow {p: 1, q: 4, m: 1}
