#> modify:restore/list/nums/1201007
# 
# 1. 基礎値を設定する
...
data modify storage modify: restore.name set value 'stage.ex1.r-legs.1.name'
...
# dyed color
data modify block ~ ~-1 ~ Items[{Slot: 13b}].components merge value {"minecraft:dyed_color": 9710479}
