#> modify:restore/list/nums/1112006
# 
# 1. 基礎値を設定する
...
scoreboard players set base Temp 87
...
scoreboard players set base Temp 57
...
data modify storage modify: restore.name set value 'stage.12.l-chest.1.name'
