#> modify:restore/list/nums/1203203
# 
# 1. 基礎値を設定する
...
scoreboard players set base Temp 149
...
data modify storage modify: restore.name set value 'stage.ex3.m-bow.3.name'

##* 武器種ごとの共通設定
function modify:restore/list/nums/type/bow {s: 0.2}
