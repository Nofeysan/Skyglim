#> modify:restore/list/nums/1115200
# 
# 1. 基礎値を設定する
...
data modify storage modify: restore.name set value 'stage.15.l-sword.3.name'

##* 武器種ごとの共通設定
function modify:restore/list/nums/type/sword {id: "carrot_on_a_stick"}
