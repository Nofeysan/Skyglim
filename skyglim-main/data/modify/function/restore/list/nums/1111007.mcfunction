#> modify:restore/list/nums/1111007
# 
# 1. 基礎値を設定する
...
scoreboard players set base Temp 55
...
scoreboard players set base Temp 34
function modify:restore/list/status/def

scoreboard players set base Temp 7
...
data modify storage modify: restore.name set value 'stage.11.e-legs.1.name'

##* 武器種ごとの共通設定
function modify:restore/list/nums/type/armor {id: "iron_leggings"}
