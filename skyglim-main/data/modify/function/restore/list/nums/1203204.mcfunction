#> modify:restore/list/nums/1203204
# 
# 1. 基礎値を設定する
...
scoreboard players set base Temp 81
...
data modify storage modify: restore.name set value 'stage.ex3.m-crossbow.3.name'

##* 武器種ごとの共通設定
function modify:restore/list/nums/type/crossbow {p: 2, q: 12, m: 3}
