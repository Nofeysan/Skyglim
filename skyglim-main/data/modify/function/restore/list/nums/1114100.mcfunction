#> modify:restore/list/nums/1114100
# 
# 1. 基礎値を設定する
...
scoreboard players set base Temp 124
...
data modify storage modify: restore.name set value 'stage.14.e-sword.2.name'

##* 武器種ごとの共通設定
function modify:restore/list/nums/type/sword {id: "wooden_axe"}
