...
data modify storage modify: restore.name set value 'stage.4.e-boots.name'

# id と見た目の設定
data modify block ~ ~-1 ~ Items[{Slot:13b}].id set value "minecraft:chainmail_boots"
#data modify block ~ ~-1 ~ Items[{Slot:13b}].components."minecraft:item_model" set value ""
data modify block ~ ~-1 ~ Items[{Slot:13b}].components."minecraft:trim" merge value {material: "minecraft:emerald", pattern: "minecraft:eye"}
