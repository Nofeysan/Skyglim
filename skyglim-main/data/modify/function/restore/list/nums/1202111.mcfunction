#> modify:restore/list/nums/1202111
# 
# 1. 基礎値を設定する
...
scoreboard players set base Temp 77
...
data modify storage modify: restore.name set value 'stage.ex2.e-shard.22.name'

##* 武器種ごとの共通設定
function modify:restore/list/nums/type/shard {id: "command_block"}
