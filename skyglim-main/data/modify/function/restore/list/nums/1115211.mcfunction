#> modify:restore/list/nums/1115211
# 
# 1. 基礎値を設定する
...
data modify storage modify: restore.name set value 'stage.15.l-shard.32.name'

##* 武器種ごとの共通設定
function modify:restore/list/nums/type/shard {id: "bowl"}
