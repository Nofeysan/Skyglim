#> modify:restore/list/nums/1203004
# 
# 1. 基礎値を設定する
...
scoreboard players set base Temp 71
...
data modify storage modify: restore.name set value 'stage.ex3.m-crossbow.1.name'

##* 武器種ごとの共通設定
function modify:restore/list/nums/type/crossbow {p: 5, q: 12, m: 1}
