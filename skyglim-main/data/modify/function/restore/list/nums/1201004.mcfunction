#> modify:restore/list/nums/1201004
# 
# 1. 基礎値を設定する
...
data modify storage modify: restore.name set value 'stage.ex1.r-crossbow.1.name'

##* 武器種ごとの共通設定
function modify:restore/list/nums/type/crossbow {p: 2, q: 15, m: 1}
