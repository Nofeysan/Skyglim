#> modify:restore/list/nums/1203006
# 
# 1. 基礎値を設定する
...
scoreboard players set base Temp 26
...
data modify storage modify: restore.name set value 'stage.ex3.m-chest.1.name'

##* 武器種ごとの共通設定
function modify:restore/list/nums/type/armor {id: "netherite_chestplate"}

# trim
data modify block ~ ~-1 ~ Items[{Slot: 13b}].components."minecraft:trim" merge value {material: "redstone", pattern: "raiser"}
