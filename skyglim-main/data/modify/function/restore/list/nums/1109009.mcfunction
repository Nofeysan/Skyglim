#> modify:restore/list/nums/1109009
# 
# 1. 基礎値を設定する
...
data modify storage modify: restore.name set value 'stage.9.n-shard.10.name'

##* 武器種ごとの共通設定
function modify:restore/list/nums/type/shard {id: "lime_dye"}
