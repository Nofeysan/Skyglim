#> modify:restore/list/nums/1202108
# 
# 1. 基礎値を設定する
...
data modify storage modify: restore.name set value 'stage.ex2.e-boots.2.name'

##* 武器種ごとの共通設定
function modify:restore/list/nums/type/armor {id: "leather_boots"}

# trim
data modify block ~ ~-1 ~ Items[{Slot: 13b}].components."minecraft:trim" merge value {material: "lapis", pattern: "raiser"}
