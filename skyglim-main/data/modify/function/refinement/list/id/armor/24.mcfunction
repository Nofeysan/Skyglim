...
execute if score rarity Temp matches 2 run data modify storage modify: temp.ref set value {damage: 0, hp: 0, str: 0, cc: -10, cd: 25, def: 0, spd: 0, mp: 0, luck: 0}
execute if score rarity Temp matches 3 run data modify storage modify: temp.ref set value {damage: 0, hp: 0, str: 0, cc: -10, cd: 35, def: 0, spd: 0, mp: 0, luck: 0}
execute if score rarity Temp matches 4 run data modify storage modify: temp.ref set value {damage: 0, hp: 0, str: 0, cc: -10, cd: 50, def: 0, spd: 0, mp: 0, luck: 0}
execute if score rarity Temp matches 5 run data modify storage modify: temp.ref set value {damage: 0, hp: 0, str: 0, cc: -10, cd: 70, def: 0, spd: 0, mp: 0, luck: 0}
