...
###* データを設定する
data modify block ~ ~-1 ~ Items[{Slot:13b}].components."minecraft:custom_data".data.refinement.ref set value 15
...
execute if score rarity Temp matches 2 run data modify storage modify: temp.ref set value {damage: 0, hp:  7, str: 0, cc: 0, cd: -10, def:  3, spd: 0, mp:  7, luck: -20}
execute if score rarity Temp matches 3 run data modify storage modify: temp.ref set value {damage: 0, hp: 13, str: 0, cc: 0, cd: -10, def:  5, spd: 0, mp: 13, luck: -20}
execute if score rarity Temp matches 4 run data modify storage modify: temp.ref set value {damage: 0, hp: 19, str: 0, cc: 0, cd: -10, def:  7, spd: 0, mp: 18, luck: -20}
execute if score rarity Temp matches 5 run data modify storage modify: temp.ref set value {damage: 0, hp: 30, str: 0, cc: 0, cd: -10, def: 13, spd: 0, mp: 27, luck: -20}
