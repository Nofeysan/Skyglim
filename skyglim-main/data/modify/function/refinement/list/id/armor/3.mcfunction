...
execute if score rarity Temp matches 1 run data modify storage modify: temp.ref set value {damage: 0, hp:  5, str: 0, cc: 0, cd: 0, def: 1, spd: 0, mp: 0, luck: 0}
execute if score rarity Temp matches 2 run data modify storage modify: temp.ref set value {damage: 0, hp: 10, str: 0, cc: 0, cd: 0, def: 3, spd: 0, mp: 0, luck: 0}
execute if score rarity Temp matches 3 run data modify storage modify: temp.ref set value {damage: 0, hp: 20, str: 0, cc: 0, cd: 0, def: 5, spd: 0, mp: 0, luck: 0}
execute if score rarity Temp matches 4 run data modify storage modify: temp.ref set value {damage: 0, hp: 30, str: 0, cc: 0, cd: 0, def: 7, spd: 0, mp: 0, luck: 0}
execute if score rarity Temp matches 5 run data modify storage modify: temp.ref set value {damage: 0, hp: 40, str: 0, cc: 0, cd: 0, def: 9, spd: 0, mp: 0, luck: 0}
