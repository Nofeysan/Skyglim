...
###* データを設定する
data modify block ~ ~-1 ~ Items[{Slot:13b}].components."minecraft:custom_data".data.refinement.ref set value 25
...
execute if score rarity Temp matches 2 run data modify storage modify: temp.ref set value {damage: 3, hp: 0, str: 0, cc: 0, cd: 0, def: 0, spd: 0, mp: 30, luck: 0}
execute if score rarity Temp matches 3 run data modify storage modify: temp.ref set value {damage: 4, hp: 0, str: 0, cc: 0, cd: 0, def: 0, spd: 0, mp: 35, luck: 0}
execute if score rarity Temp matches 4 run data modify storage modify: temp.ref set value {damage: 5, hp: 0, str: 0, cc: 0, cd: 0, def: 0, spd: 0, mp: 40, luck: 0}
execute if score rarity Temp matches 5 run data modify storage modify: temp.ref set value {damage: 6, hp: 0, str: 0, cc: 0, cd: 0, def: 0, spd: 0, mp: 50, luck: 0}
