...
execute if score rarity Temp matches 2 run data modify storage modify: temp.ref set value {damage: 0, hp: 0, str: -7, cc: 0, cd: 0, def:  9, spd: 0, mp: 0, luck: 0}
execute if score rarity Temp matches 3 run data modify storage modify: temp.ref set value {damage: 0, hp: 0, str: -7, cc: 0, cd: 0, def: 17, spd: 0, mp: 0, luck: 0}
execute if score rarity Temp matches 4 run data modify storage modify: temp.ref set value {damage: 0, hp: 0, str: -7, cc: 0, cd: 0, def: 26, spd: 0, mp: 0, luck: 0}
execute if score rarity Temp matches 5 run data modify storage modify: temp.ref set value {damage: 0, hp: 0, str: -7, cc: 0, cd: 0, def: 35, spd: 0, mp: 0, luck: 0}
