...
execute if score rarity Temp matches 2 run data modify storage modify: temp.ref set value {damage: 2, hp: 0, str:  5, cc:  3, cd: 12, def: 0, spd: -50, mp: 0, luck: 0}
execute if score rarity Temp matches 3 run data modify storage modify: temp.ref set value {damage: 3, hp: 0, str:  8, cc:  5, cd: 22, def: 0, spd: -50, mp: 0, luck: 0}
execute if score rarity Temp matches 4 run data modify storage modify: temp.ref set value {damage: 5, hp: 0, str: 13, cc:  8, cd: 35, def: 0, spd: -50, mp: 0, luck: 0}
execute if score rarity Temp matches 5 run data modify storage modify: temp.ref set value {damage: 7, hp: 0, str: 18, cc: 12, cd: 49, def: 0, spd: -50, mp: 0, luck: 0}
