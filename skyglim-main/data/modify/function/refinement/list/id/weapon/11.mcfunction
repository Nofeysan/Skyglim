...
execute if score rarity Temp matches 2 run data modify storage modify: temp.ref set value {damage: 0, hp: 0, str:  3, cc: 2, cd:  7, def: 0, spd: 2, mp: 0, luck: 10}
execute if score rarity Temp matches 3 run data modify storage modify: temp.ref set value {damage: 0, hp: 0, str:  4, cc: 3, cd: 10, def: 0, spd: 2, mp: 0, luck: 10}
execute if score rarity Temp matches 4 run data modify storage modify: temp.ref set value {damage: 0, hp: 0, str:  8, cc: 5, cd: 14, def: 0, spd: 5, mp: 0, luck: 20}
execute if score rarity Temp matches 5 run data modify storage modify: temp.ref set value {damage: 0, hp: 0, str: 12, cc: 7, cd: 17, def: 0, spd: 7, mp: 0, luck: 20}
