...
execute if score rarity Temp matches 2 run data modify storage modify: temp.ref set value {damage: 0, hp: 0, str:  4, cc: 0, cd: 10, def: 0, spd: 0, mp: 0, luck:  8}
execute if score rarity Temp matches 3 run data modify storage modify: temp.ref set value {damage: 0, hp: 0, str:  7, cc: 0, cd: 20, def: 0, spd: 0, mp: 0, luck: 16}
execute if score rarity Temp matches 4 run data modify storage modify: temp.ref set value {damage: 0, hp: 0, str: 12, cc: 0, cd: 33, def: 0, spd: 0, mp: 0, luck: 25}
execute if score rarity Temp matches 5 run data modify storage modify: temp.ref set value {damage: 0, hp: 0, str: 15, cc: 0, cd: 45, def: 0, spd: 0, mp: 0, luck: 36}
