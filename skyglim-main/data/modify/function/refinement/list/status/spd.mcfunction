...
execute if score restore Temp matches 2 run function modify:refinement/list/status/roll/spd with storage modify: setlore

# roll がない時
execute unless score restore Temp matches 2 run function modify:refinement/list/status/no_roll/spd with storage modify: setlore
