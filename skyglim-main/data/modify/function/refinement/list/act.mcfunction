...
execute if score rarity Temp matches 2 store result score roll Temp run random value 1..5
execute if score rarity Temp matches 3 store result score roll Temp run random value 1..5
execute if score rarity Temp matches 4 store result score roll Temp run random value 1..5
execute if score rarity Temp matches 5 store result score roll Temp run random value 1..5
