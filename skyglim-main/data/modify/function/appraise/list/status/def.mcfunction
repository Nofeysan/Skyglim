...
function modify:appraise/list/macro/status/def with storage modify: appraise
...
# roll に乱数を保存する
execute store result block ~ ~-1 ~ Items[{Slot:13b}].components."minecraft:custom_data".data.roll.def int 1 run scoreboard players get rate Temp
