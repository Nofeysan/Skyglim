                ...
                entity: {\
                    ...
                    Passengers: [\
                        {\
                            ...
                            equipment: {\
                                head: {id: "minecraft:honey_block", components: {"minecraft:unbreakable": {}, "minecraft:enchantment_glint_override": true}},\
                                ...
                                mainhand: {id: "minecraft:honey_block", components: {"minecraft:enchantment_glint_override": true}},\
                                offhand: {id: "minecraft:honey_block", components: {"minecraft:enchantment_glint_override": true}},\
                            },\
                            drop_chances: {\
                                head: 0.0f, chest: 0.0f, legs: 0.0f, feet: 0.0f, mainhand: 0.0f, offhand: 0.0f\
                            },\
                            CustomName: {translate: "entity.stage.6.2.name", color: "#ffffff", italic: false},\
                            data: {\
                                "status": {\
                                    "max_hp": 19400,\
                                    "current_hp": 19400,\
