...
loot replace block ~ ~-1 ~ container.1 loot modify:gray_glass
loot replace block ~ ~-1 ~ container.2 loot shop:armor/tier1/head
loot replace block ~ ~-1 ~ container.3 loot shop:armor/tier1/chest
loot replace block ~ ~-1 ~ container.4 loot modify:gray_glass
loot replace block ~ ~-1 ~ container.5 loot shop:armor/tier1/legs
loot replace block ~ ~-1 ~ container.6 loot shop:armor/tier1/boots
