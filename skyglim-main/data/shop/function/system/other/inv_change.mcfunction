...
loot replace block ~ ~-1 ~ container.1 loot shop:other/food/chicken
loot replace block ~ ~-1 ~ container.2 loot shop:other/food/heart_berry
loot replace block ~ ~-1 ~ container.3 loot shop:other/food/yellow_berry
loot replace block ~ ~-1 ~ container.4 loot modify:gray_glass
loot replace block ~ ~-1 ~ container.5 loot shop:other/arrow/normal
